...
/*
 * XU Control Selectors, used in switch command
 **/
...
#define UVC_CONTROL_RESTORE		(1 << 6)		/* Control should be saved at suspend and restored at resume. */
#define UVC_CONTROL_AUTO_UPDATE	(1 << 7)		/* Control can be updated by the camera. */
...
#define MULTI_STREAM_HD_QVGA_QQVGA	4
#define MULTI_STREAM_HD_VGA			8
#define MULTI_STREAM_HD_VGA_QVGA	16
